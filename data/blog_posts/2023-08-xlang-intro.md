...
Throughout this process, we have maintained active collaborations with industry players like Salesforce, Microsoft, Amazon, Facebook, Google, especially in the realm of text-to-SQL and code generation. We were also among the pioneers in working with large language models for in-context learning ([**Selective Annotation** (ICLR 2023)](https://github.com/HKUNLP/icl-selective-annotation)), LLM + tool use ([**Binder** (ICLR 2023)](https://lm-code-binder.github.io/)), instruction tuning and retrieval embeddings for LLM ([**Instructor Embeddings** (ACL 2023 Findings)](https://instructor-embedding.github.io/)), code generation and semantic parsing ([**Spider**(EMNLP 2018)](https://yale-lily.github.io/spider), [**DS-1000** (ICML 2023)](https://ds1000-code-gen.github.io/), [**Coder-Reviewer Reranking** (ICML 2023)](https://arxiv.org/abs/2211.16490), [**UnifiedSKG** (EMNLP 2022)](https://github.com/HKUNLP/UnifiedSKG)),and interactive dialog systems ([**ICL-DST** (EMNLP Findings 2022)](https://github.com/Yushi-Hu/IC-DST), [**SParC** (ACL 2019)](https://yale-lily.github.io/sparc), [**CoSQL** (EMNLP 2019)](https://yale-lily.github.io/cosql), [**NL2Interface** (NLVIZ 2022)](https://arxiv.org/abs/2209.08834)). More about our research can be found on our [project page](https://www.xlang.ai/project). 
